...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Platform, Image, ActivityIndicator, Modal, Dimensions } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      {isUploading && (
        <View style={styles.loadingOverlay}>
          <View style={styles.loadingBox}>
            ...
            <Text style={styles.loadingText}>Enviando para o servidor...</Text>
      ...
      <Modal visible={!!previewType} transparent={false} animationType="slide" onRequestClose={closePreview}>
        <View style={styles.modalContainer}>
          ...
          {/* Área da Imagem com Scroll (Para suportar múltiplas páginas de questões) */}
...
const styles = StyleSheet.create({
  ...
  loadingText: { fontSize: 16, fontWeight: 'bold', color: COLORS.titleDark, marginTop: 15, textAlign: 'center' },
  ...
  fullscreenImageContainer: {
    width: width, // Ocupa exatamente a largura da tela para o "paginação" funcionar
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
  },
